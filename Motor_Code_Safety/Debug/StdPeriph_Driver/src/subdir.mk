...
StdPeriph_Driver/src/%.o: ../StdPeriph_Driver/src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -DSTM32 -DSTM32F3 -DSTM32F30 -DSTM32F303VCTx -DSTM32F3DISCOVERY -DDEBUG -DSTM32F303xC -DUSE_STDPERIPH_DRIVER -I"/home/gauravkh/workspace/Motor_Code_Safety/Utilities" -I"/home/gauravkh/workspace/Motor_Code_Safety/StdPeriph_Driver/inc" -I"/home/gauravkh/workspace/Motor_Code_Safety/inc" -I"/home/gauravkh/workspace/Motor_Code_Safety/CMSIS/device" -I"/home/gauravkh/workspace/Motor_Code_Safety/CMSIS/core" -O0 -g3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
